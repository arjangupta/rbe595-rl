...
\begin{homeworkProblem}[Problem 7]
    ...
    The Dyna-Q+ agent performed better in the first phase because it was able to explore
    the environment better than the Dyna-Q agent. This is because the Dyna-Q+ agent
    had an exploration bonus in the planning phase, which encouraged it to explore
    the environment.\\

    The Dyna-Q+ agent performed better in the second phase because it was able to
    learn the new environment faster than the Dyna-Q agent. This is because the Dyna-Q+
    agent had an exploration bonus in the planning phase, which encouraged it to explore
    the environment. This allowed it to learn the new environment faster than the Dyna-Q
    agent.\\
