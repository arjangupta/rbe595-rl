...
class AerialRobotCfgFinalProject(BaseConfig):
    ...
    class left_wall(asset_state_params):
        ...
        specified_position = [15, 5, 10]  # if > -900, use this value instead of randomizing the ratios
    ...
    class slanted_wall_left(asset_state_params):
        num_assets = 1
        ...
        specified_position = [11.768, -8.232, 10]  # if > -900, use this value instead of randomizing the ratios
    ...
    class slanted_wall_right(asset_state_params):
        num_assets = 1
    ...
    class thin_wall_front_left(asset_state_params):
        num_assets = 1
        ...
        specified_position = [5, -10, 10]  # if > -900, use this value instead of randomizing the ratios
    ...
    class thin_wall_front_right(asset_state_params):
        num_assets = 1
    ...
    class thin_wall_back_right(asset_state_params):
        num_assets = 1
        ...
        specified_position = [18.53, 6.464, 10]  # if > -900, use this value instead of randomizing the ratios
    ...
    class thin_wall_back_left(asset_state_params):
        num_assets = 1
    ...
    class thin_wall_obstacle1(asset_state_params):
        num_assets = 1
        ...
        specified_position = [5, -2.5, 10]  # if > -900, use this value instead of randomizing the ratios
    ...
    class thin_wall_obstacle2(asset_state_params):
        num_assets = 1
        ...
        specified_position = [10, 2.5, 10]  # if > -900, use this value instead of randomizing the ratios
    ...
    class thin_wall_obstacle3(asset_state_params):
        num_assets = 1
        ...
        specified_position = [15, -2.5, 10]  # if > -900, use this value instead of randomizing the ratios
    ...
    class w(asset_state_params):
        ...
        specified_position = [20, 2.5, 10]  # if > -900, use this value instead of randomizing the ratios

        min_euler_angles = [0.0, 0.0, 0.0]  # min euler angles
        max_euler_angles = [0.0, 0.0, 0.0]  # max euler angles

        specified_euler_angle = [0, 0, 1.5]  # if > -900, use this value instead of randomizing
