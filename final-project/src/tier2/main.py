...
import torch
from aeriel_robot_cfg_final_project import AerialRobotCfgFinalProjectTier2
from aeriel_robot_final_project import AerialRobotFinalProjectTier2
...
class GymInterface:
    def __init__(self, debug=False):
        ...
        self.trace = False
        # Declare environment
        task_registry.register("quad_for_final_project", AerialRobotFinalProjectTier2,
                               AerialRobotCfgFinalProjectTier2())
        # Create environment
