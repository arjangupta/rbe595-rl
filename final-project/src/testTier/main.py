...
import torch
from aeriel_robot_cfg_final_project import AerialRobotCfgFinalProjectTierTest
from aeriel_robot_final_project import AerialRobotFinalProjectTierTest
...
class GymInterface:
    def __init__(self, debug=False):
        ...
        self.trace = False
        # Declare environment
        task_registry.register("quad_for_final_project", AerialRobotFinalProjectTierTest,
                               AerialRobotCfgFinalProjectTierTest())
        # Create environment
