...
\begin{homeworkProblem}[Problem 4]
    ...
    The purpose of using UCB is to choose actions according to their potential for actually being optimal
    (as against a random choice as in the case for epsilon-greedy).\\
    ...
    and $c$ is used to control the confidence level of that uncertainty. Therefore, at any given time
    step, we are finding the maximum possible value, or the `upper bound' on what we believe to be the
    true value of the action. Therefore, UCB is used to approach the true value of an action in a more
    `systematic' way than epsilon-greedy.
