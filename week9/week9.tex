...
\begin{homeworkProblem}[Problem 1]
    ...
    \begin{align*}
        q_{\pi}(X, U2) &= q_{\pi}(X, U2) + \alpha \left[ R_{t+1} + \gamma R_{t+2} + \gamma^2 q_{\pi}(S_{t+2}, A_{t+2}) - q_{\pi}(X, U2) \right]\\
                      ...
                      &= 0 + 0.1 \left[ 12 + 12 - 2.2 \right]\\
                      &= 0 + 0.1 \left[ 24 - 2.2 \right]\\
                      &= 0 + 0.1 \left[ 21.8 \right]\\
                    &= 2.18\\
    \end{align*}
    ...
    Therefore, the estimate of $q_{\pi}(X, U1)$ is $5.18$ and the estimate of $q_{\pi}(X, U2)$ is $2.18$.
