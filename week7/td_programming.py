...
def main(epsilon_decay):
    ...
    ql_agent = QLearningAgent(alpha=0.05, num_runs=20, use_epsilon_decay=epsilon_decay)
    ql_agent.learn()

    # Train a SARSA agent
    sarsa_agent = SARSAAgent(alpha=0.05, num_runs=20, use_epsilon_decay=epsilon_decay)
    sarsa_agent.learn()
